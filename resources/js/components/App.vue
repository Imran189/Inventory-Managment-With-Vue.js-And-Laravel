            ...
            >
                    ...
                    >
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="dropdowns.html"
                                >Dropdowns</a
                            >
                            <a class="collapse-item" href="modals.html"
                                >Modals</a
                            >
                ...
                <li class="nav-item">
                    <a class="nav-link" href="forms.html">
                        <i class="fab fa-fw fa-wpforms"></i> <span>Forms</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a
                ...
                <li class="nav-item">
                    ...
                    >
                        <i class="fas fa-fw fa-columns"></i> <span>Pages</span>
                    </a>
                    <div
                        id="collapsePage"
                        class="collapse"
                                ...
                                >
                                    ...
                                    >
                                        <div class="dropdown-list-image mr-3">
                                            <img
                                                class="rounded-circle"
                                                src="backend/img/girl.png"
                                                style="max-width: 60px"
                                                alt=""
                                            />
                                            <div
                                                class="status-indicator bg-default"
                                            ></div>
                                        </div>
                                        <div>
                                            <div class="text-truncate">
